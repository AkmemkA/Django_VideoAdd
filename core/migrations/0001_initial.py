# Generated by Django 4.2.5 on 2023-09-24 22:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=16, validators=[django.core.validators.RegexValidator(message='Password must be 8 to 16 characters and contain at least 1 digit.', regex='^(?=.*?[0-9]).{8,}$')])),
